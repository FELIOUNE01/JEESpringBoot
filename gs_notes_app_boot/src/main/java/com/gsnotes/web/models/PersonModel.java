...
public class PersonModel {
	...
	public PersonModel(Long idUtilisateur, @NotBlank(message = "This field is required") String nom,
			@NotBlank(message = "This field is required") String prenom, String cne, String grade, int typePerson) {
		super();
